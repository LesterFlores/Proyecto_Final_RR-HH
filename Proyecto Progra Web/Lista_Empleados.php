<?php
    ...
    $consulta = "SELECT * FROM tbl_empleados em JOIN tbl_area_trabajo ar 
    ...
    while($registro=mysqli_fetch_assoc($resultado)){
        ...
        $tabla.= "<td><a href='Actualizar.php?id={$registro['ID_Empleado']}'>Editar</a> <a href='ac_eliminar_empleado.php?id={$registro['ID_Empleado']}'>Elimiinar</a></td>";
        $tabla.= "</tr>";
    }
    $tabla.="<tbody>";
    $tabla.="<tfoot>";
...
<div class="topnav" id="myTopnav">
  <a href="Lista_Empleados.php" class="active">Lista de Empleados</a>
