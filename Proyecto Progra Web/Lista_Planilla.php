<?php
    ...
    while($registro=mysqli_fetch_assoc($resultado)){
        ...
        $tabla.= "<td><a href='Actualizar_planilla.php?id={$registro['ID_Empleado']}'>Editar</a> <a href='ac_eliminar_planilla.php?id={$registro['ID_Empleado']}'>Elimiinar</a></td>";
        $tabla.= "</tr>";
...
<div class="topnav" id="myTopnav">
  ...
  <a href="Lista_Planilla.php" class="active">Lista de Planilla</a>
...
<a href="salir.php"><button style="background-color: red; margin-left: 1379px;"> Cerrar Sesion</button></a>
    ...
    <center><h1>Lista de Planilla</h1></center>
